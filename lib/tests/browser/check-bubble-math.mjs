...
// the pushed plugin (see docs/wtf-234/verification.md). Typesetting formulas
// that rendered before KaTeX arrived is covered by math-lifecycle.mjs and
// math.spec.mjs.
...
try {
  ...
  const result = await page.evaluate(async () => {
    ...
    // The element typesets waiting formulas itself (initialize.js); this bare
    // editor is only mounted once KaTeX is there.
