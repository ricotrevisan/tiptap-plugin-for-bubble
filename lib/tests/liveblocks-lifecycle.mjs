...
staleSession.events.status.notify("disconnected");
staleSession.events.others.notify({ type: "leave", user: {}, others: [] });
assert.deepEqual(a.states, statesBefore);

// 6. Teardown is idempotent: rooms are left, subscriptions released and each
