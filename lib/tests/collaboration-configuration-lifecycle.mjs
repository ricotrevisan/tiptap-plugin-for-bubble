...
const liveblocks = createFakeLiveblocks(window.tiptap.Y);
window.tiptap.createClient = options => liveblocks.createClient(options);
...
assert.equal(liveblocks.left, 3);
assert.equal(liveblocks.sessions.size, 0);
